...
## [4.0.2]
### Uncategorized
- Bump snaps-sdk version ([#271](https://github.com/MetaMask/keyring-api/pull/271))
- chore(deps): bump @metamask/safe-event-emitter from 3.0.0 to 3.1.0 ([#270](https://github.com/MetaMask/keyring-api/pull/270))
- ci: update security code scanner file ([#269](https://github.com/MetaMask/keyring-api/pull/269))
