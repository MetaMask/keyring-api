...
## [1.0.0]
### Uncategorized
- chore(deps): bump @metamask/rpc-errors from 6.0.0 to 6.1.0 ([#151](https://github.com/MetaMask/keyring-api/pull/151))
- chore(deps): bump postcss from 8.4.24 to 8.4.31 ([#150](https://github.com/MetaMask/keyring-api/pull/150))
- docs: update README ([#149](https://github.com/MetaMask/keyring-api/pull/149))
- docs: add account snaps security guidelines ([#143](https://github.com/MetaMask/keyring-api/pull/143))
