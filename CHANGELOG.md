...
## [6.3.0]
### Uncategorized
- chore(deps): bump @metamask/snaps-sdk from 4.2.0 to 4.3.0 ([#323](https://github.com/MetaMask/keyring-api/pull/323))
- feat: add `getAccountBalances` method to `Keyring` ([#320](https://github.com/MetaMask/keyring-api/pull/320))
- feat: add CAIP-19 types and split `utils` ([#321](https://github.com/MetaMask/keyring-api/pull/321))
- refactor: split `api.ts` ([#319](https://github.com/MetaMask/keyring-api/pull/319))
- fix: ensure that errors are JSON-serializable ([#162](https://github.com/MetaMask/keyring-api/pull/162))
- fix: don't use internal types in the public API ([#312](https://github.com/MetaMask/keyring-api/pull/312))
- fix: keep all ETH methods in the same `enum` ([#313](https://github.com/MetaMask/keyring-api/pull/313))
- feat: make the `KeyringAccount` type "abstract" ([#311](https://github.com/MetaMask/keyring-api/pull/311))
