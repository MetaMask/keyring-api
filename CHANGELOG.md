...
## [5.0.0]
### Uncategorized
- fix: bundler type ([#277](https://github.com/MetaMask/keyring-api/pull/277))
- feat!: add KeyringExecutionContext to user ops methods ([#275](https://github.com/MetaMask/keyring-api/pull/275))
- chore(deps): bump @metamask/providers from 15.0.0 to 16.0.0 ([#276](https://github.com/MetaMask/keyring-api/pull/276))
- chore(deps): bump @metamask/safe-event-emitter from 3.1.0 to 3.1.1 ([#274](https://github.com/MetaMask/keyring-api/pull/274))
