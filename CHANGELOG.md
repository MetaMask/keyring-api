...
## [5.1.0]
### Uncategorized
- refactor: use @metamask/providers as a peer dependency ([#282](https://github.com/MetaMask/keyring-api/pull/282))
- chore(deps): bump @metamask/utils from 8.3.0 to 8.4.0 ([#280](https://github.com/MetaMask/keyring-api/pull/280))
- ci: add stale workflow to close issues and PRs ([#279](https://github.com/MetaMask/keyring-api/pull/279))
