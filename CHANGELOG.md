...
## [3.0.0]
### Uncategorized
- chore(deps): bump @metamask/utils from 8.2.1 to 8.3.0 ([#238](https://github.com/MetaMask/keyring-api/pull/238))
- feat: remove `KeyringSnapControllerClient` to fix dependency problems ([#241](https://github.com/MetaMask/keyring-api/pull/241))
- chore: bump Snap depdencies ([#236](https://github.com/MetaMask/keyring-api/pull/236))
- chore(deps): bump @metamask/approval-controller from 5.0.0 to 5.1.1 ([#225](https://github.com/MetaMask/keyring-api/pull/225))
- chore(deps): bump @metamask/base-controller from 4.0.0 to 4.0.1 ([#226](https://github.com/MetaMask/keyring-api/pull/226))
- chore(deps): bump @metamask/json-rpc-engine from 7.3.0 to 7.3.1 ([#227](https://github.com/MetaMask/keyring-api/pull/227))
- chore(deps-dev): bump @metamask/auto-changelog from 3.4.3 to 3.4.4 ([#223](https://github.com/MetaMask/keyring-api/pull/223))
- chore(deps): bump @metamask/snaps-sdk from 1.3.0 to 1.3.1 ([#222](https://github.com/MetaMask/keyring-api/pull/222))
