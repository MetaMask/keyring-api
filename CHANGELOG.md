...
## [4.1.0]
### Uncategorized
- chore: bump dependencies ([#266](https://github.com/MetaMask/keyring-api/pull/266))
- chore(deps): bump @metamask/json-rpc-engine from 7.3.2 to 7.3.3 ([#264](https://github.com/MetaMask/keyring-api/pull/264))
- docs: add note to `eth_prepareUserOperation` method response ([#263](https://github.com/MetaMask/keyring-api/pull/263))
- chore(deps): bump @metamask/snaps-sdk from 3.0.0 to 3.0.1 ([#261](https://github.com/MetaMask/keyring-api/pull/261))
- Enabling MetaMask security code scanner ([#260](https://github.com/MetaMask/keyring-api/pull/260))
- chore(deps): bump @metamask/snaps-sdk from 1.4.0 to 3.0.0 ([#259](https://github.com/MetaMask/keyring-api/pull/259))
- chore(deps): bump @metamask/rpc-errors from 6.1.0 to 6.2.1 ([#258](https://github.com/MetaMask/keyring-api/pull/258))
...
[Unreleased]: https://github.com/MetaMask/keyring-api/compare/v4.1.0...HEAD
[4.1.0]: https://github.com/MetaMask/keyring-api/compare/v4.0.0...v4.1.0
