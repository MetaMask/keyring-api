...
## [3.1.0]
### Uncategorized
- docs: update `eth_prepareUserOperation` argument to not be an array ([#252](https://github.com/MetaMask/keyring-api/pull/252))
- chore(deps): bump ip from 2.0.0 to 2.0.1 ([#253](https://github.com/MetaMask/keyring-api/pull/253))
- feat: update `eth_patchUserOperation` to return optional gas limit values ([#250](https://github.com/MetaMask/keyring-api/pull/250))
- chore(deps): bump @metamask/json-rpc-engine from 7.3.1 to 7.3.2 ([#246](https://github.com/MetaMask/keyring-api/pull/246))
- chore: update node min version ([#247](https://github.com/MetaMask/keyring-api/pull/247))
- chore(deps): bump @metamask/snaps-sdk from 1.3.2 to 1.4.0 ([#243](https://github.com/MetaMask/keyring-api/pull/243))
...
[Unreleased]: https://github.com/MetaMask/keyring-api/compare/v3.1.0...HEAD
[3.1.0]: https://github.com/MetaMask/keyring-api/compare/v3.0.0...v3.1.0
