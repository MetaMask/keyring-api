...
- Add bip122:p2wpkh account support ([#294](https://github.com/MetaMask/keyring-api/pull/294))

### Changed

- Fixed removed incorrect signTransaction from EthErc4337Account ([#300](https://github.com/MetaMask/keyring-api/pull/300))
