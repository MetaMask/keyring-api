...
## [6.1.0]
### Uncategorized
- feat: add isEVMAccount helper ([#297](https://github.com/MetaMask/keyring-api/pull/297))
- fix: remove signTransaction from EthErc4337Account ([#300](https://github.com/MetaMask/keyring-api/pull/300))
- chore(deps-dev): bump @metamask/providers from 16.0.0 to 16.1.0 ([#298](https://github.com/MetaMask/keyring-api/pull/298))
- docs: add `btc_sendmany` method ([#295](https://github.com/MetaMask/keyring-api/pull/295))
- feat: add bip122:p2wpkh account support ([#294](https://github.com/MetaMask/keyring-api/pull/294))
- refactor: split account types ([#293](https://github.com/MetaMask/keyring-api/pull/293))
- chore(deps): bump @metamask/snaps-sdk from 4.0.0 to 4.0.1 ([#292](https://github.com/MetaMask/keyring-api/pull/292))
