...
## [7.0.0]
### Uncategorized
- chore(deps): bump @metamask/snaps-sdk from 4.4.1 to 4.4.2 ([#339](https://github.com/MetaMask/keyring-api/pull/339))
- feat: add `getAccountBalances` to `KeyringClient` ([#340](https://github.com/MetaMask/keyring-api/pull/340))
- feat: allow multiple address per account ([#315](https://github.com/MetaMask/keyring-api/pull/315))
- chore(deps): bump @metamask/rpc-errors from 6.2.1 to 6.3.0 ([#337](https://github.com/MetaMask/keyring-api/pull/337))
- ci: allow stale action to be run manually and fix permissions ([#336](https://github.com/MetaMask/keyring-api/pull/336))
