...
## [6.2.1]
### Uncategorized
- fix: use internal `object` function instead of the upstream one ([#316](https://github.com/MetaMask/keyring-api/pull/316))
- chore(deps): bump @metamask/key-tree from 9.1.0 to 9.1.1 ([#310](https://github.com/MetaMask/keyring-api/pull/310))
